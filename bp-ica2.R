...
index.kernelica <- which(lapply(c.kica, function(x) x) %>% 
...
final.index.kica <- index.kernelica[index.neg.kica$neg_index[1]]
...
coef.kica <- getcoefSVARS(x = var.irf,B_hat = Aidkica)
